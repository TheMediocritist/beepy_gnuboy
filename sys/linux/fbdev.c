	...
	for (int row = 60; row < 180; row++)
		{
			for (int b = 0; b < 640; b++)
			{
				int src_x = 480 + b;
				int dst_x = 160 + b; 
				fbmap[(row-60)*1600 + dst_x*2] = new_fbmap[row*1600+src_x];
				fbmap[(row-60)*1600 + dst_x*2+4] = new_fbmap[row*1600+src_x];
				//fbmap[(row-60)*1600 + dst_x + 1600] = new_fbmap[row*1600+src_x];
